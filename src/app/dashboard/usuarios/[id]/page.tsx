    ...
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <p>Modo visualización: {user.nombre} {user.apellido}</p>
          </div>
        </div>
      </div>
      ...
      <Tabs value={currentTab} onValueChange={handleTabChange} className="w-full">
        <TabsList className="grid w-full grid-cols-4 lg:w-[600px]">
          ...
          <TabsTrigger value="eliminar" className="text-red-600 data-[state=active]:text-red-600">
            Eliminar cuenta
          </TabsTrigger>
        </TabsList>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div className="space-y-2">
                  <Label className="text-muted-foreground">Rol del Sistema</Label>
                  <Input 
                    value={user.role} 
                    disabled 
                    className="cursor-not-allowed bg-muted/50 font-medium text-foreground" 
          ...
          <Card className="border-red-200">
            ...
            <CardContent className="pt-6">
              <p className="text-sm text-muted-foreground mb-4">
                Esta acción es irreversible y eliminará permanentemente al usuario y sus datos asociados.
              </p>
              <div className="flex justify-end">
                <AlertDialog>
                  <AlertDialogTrigger asChild>
                    <Button variant="destructive"><Trash2 className="mr-2 h-4 w-4"/> Eliminar Cuenta</Button>
                  </AlertDialogTrigger>
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      <AlertDialogTitle>¿Está absolutamente seguro?</AlertDialogTitle>
                      <AlertDialogDescription>Se eliminará el usuario <strong>{user.email}</strong> permanentemente.</AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
                      <AlertDialogCancel>Cancelar</AlertDialogCancel>
                      <AlertDialogAction onClick={handleDelete} className="bg-red-600 text-white" disabled={isDeleting}>
